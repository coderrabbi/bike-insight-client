    ...
    <div className={`${styles.padding}  flex flex-col items-center`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-3 justify-center">
        {data.map((item) => (
          <div
            key={item?._id}
            className="max-w-sm pb-16 bg-white flex flex-col shadow-lg rounded-lg overflow-hidden my-4 relative"
          >
            <img
              ...
              <div className="grid grid-cols-2">
                <div className="flex items-center  text-gray-700">
                  ...
                  <h1 className="px-2 text-sm">
                    {item.username ? item.username : "Golam Rabbi"}
                  </h1>
                </div>
                <div className="flex items-center  text-gray-700">
                  <svg className="h-6 w-6 fill-current" viewBox="0 0 512 512">
                ...
                <div className="flex items-center  text-gray-700">
                  ...
                  <h1 className="px-2 text-sm">
                    {item.email ? item.email : "golamrabbi@gmail.com"}
                  </h1>
                </div>
            ...
            {/* modal */}
            <div className="text-center my-3 absolute bottom-3 left-[34%]">
              <label
                htmlFor="my-modal-3"

...
const MyOrders = () => {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_SERVER_BASE_URL}/bookings?email=${user?.email}`, {
            headers: {
    ...
    const handelDelete = (id) => {
        ...
        Confirm.show(
            'Confirm Delete',
            'Do you Delete the product?',
            'Yes',
            'No',
            () => {
                fetch(`${process.env.REACT_APP_SERVER_BASE_URL}/bookings/${id}`, {
                    method: 'DELETE',
                })
                    .then((res) => res.json())
                    .then((data) => {

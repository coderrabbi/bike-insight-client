...
export const routes = createBrowserRouter([
    { path: '*', element: <NotFound /> },
    {
        ...
        children: [
            ...
            {
                path: '/advertiseitems',
                loader: () => fetch(`${process.env.REACT_APP_SERVER_BASE_URL}/products`),
                element: <AdvertiseProduct />,
            },
            {
                path: '/products/:category',
                loader: ({ params }) =>
                    fetch(`${process.env.REACT_APP_SERVER_BASE_URL}/products/${params.category}`),
                element: (
                    <PrivetRouter>
                        <Bikes />
                    </PrivetRouter>
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                element: <Payment />,
                loader: ({ params }) =>
                    fetch(`${process.env.REACT_APP_SERVER_BASE_URL}/bookings/${params.id}`),
            },
            {
